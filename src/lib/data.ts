...
export const recruiterMonetizationData = {
  monthly: [
    { label: 'Jan', amount: 15000, commission: 75, workers: 5 },
    { label: 'Feb', amount: 12000, commission: 60, workers: 4 },
  ...
  weekly: [
    { label: 'W1', amount: 5000, commission: 25, workers: 2 },
    { label: 'W2', amount: 4000, commission: 20, workers: 2 },
