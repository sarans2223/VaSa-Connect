...
export const recruiterMonetizationData = {
  monthly: [
    ...
    { label: 'Mar', amount: 20000, commission: 100, workers: 8 },
    { label: 'Apr', amount: 18000, commission: 90, workers: 6 },
    { label: 'May', amount: 25000, commission: 125, workers: 10 },
    { label: 'Jun', amount: 22000, commission: 110, workers: 9 },
  ],
  weekly: [
    { label: 'W1', amount: 5000, commission: 250, workers: 2 },
    { label: 'W2', amount: 4000, commission: 200, workers: 2 },
    { label: 'W3', amount: 7000, commission: 35, workers: 3 },
    { label: 'W4', amount: 6000, commission: 30, workers: 2 },
  ],
  last_10_days: [
    { label: 'Day 1', amount: 0, commission: 0, workers: 0 },
    { label: 'Day 2', amount: 1500, commission: 7.5, workers: 1 },
    { label: 'Day 3', amount: 2000, commission: 10, workers: 2 },
    { label: 'Day 4', amount: 0, commission: 0, workers: 0 },
    { label: 'Day 5', amount: 3000, commission: 15, workers: 2 },
    { label: 'Day 6', amount: 0, commission: 0, workers: 0 },
    { label: 'Day 7', amount: 2500, commission: 12.5, workers: 1 },
    { label: 'Day 8', amount: 0, commission: 0, workers: 0 },
    { label: 'Day 9', amount: 1000, commission: 5, workers: 1 },
    { label: 'Day 10', amount: 4000, commission: 20, workers: 3 },
  ],
};
